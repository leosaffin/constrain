...
copied from https://gist.github.com/leifdenby/de893d663c0643a0a0388583f93fd388
...
def usage_examples():
    ...
    find_cmip6_file(model=Models.HadGEM3_GC31_LL, variable="tas", experiment="historical",
                          time_frequency="day")
    find_cmip6_file(model="UKESM1-0-LL", variable="tas", experiment="historical", time_frequency="day")

    # getting future scenarios
    find_cmip6_file(model="UKESM1-0-LL", variable="tas", experiment="ssp585", time_frequency="day")
